...
#define  MOT   P3_0//P4_1
//-----------------
#define  FOT   P0_5//P1_5		 pwm2
#define  DOT1  P1_6//P1_6	p1.6 pwm0
#define  DOT2  P0_7//P1_7		 pwm3
//-----------------
#define  IR    P1_4//P1_2
//-----------------
...
*功能说明:  I/O引脚备置
************************************************************/
#define   AD_NTC  0X81	//an0	adc1
#define   AD_VR   0X89	//an4	adc4
/************************************************************
*函数名:
*功能说明:  中断向量表
************************************************************/
...
#define d_RELOADVALUE_T2    6666 //User Define Reload Value
