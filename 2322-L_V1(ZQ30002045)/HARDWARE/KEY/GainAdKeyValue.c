...
//						  TSE TIM HEA FLA POW
  u8  code AdKeyConst[]   ={72, 52, 33, 12,  0};
  u8  code KeyValueTable[]={ 0,  4,  5,  2,  1};
#else
//   #define  KEY_SIZE     7
...
//									     VOD  UP DOW TIM HEA FLA POW
	...
	#if (TOCH_ANKEY==0)
	unsigned char code KeyValueTable0[7]={ 0 , 4 ,  2,  1,  5,  0,  0};
	#else
	unsigned char code KeyValueTable0[7]={ 0 , 0 ,  0,  4,  5,  2,  1};
	#endif
	//------------------------------------------------------------------
	unsigned char  code AdKeyConst1[8]   ={190, 164, 148, 134, 120, 106, 94,  80};
    unsigned char code KeyValueTable1[8] ={0 ,   2 ,  0,   0,   4,   0,   1,   5};
