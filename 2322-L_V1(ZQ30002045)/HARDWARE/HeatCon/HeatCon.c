...
* 正数、负数：为温度控制范为，正负多少度
***********************************************************/
#define   TEMP_ADJUST               3.5	/* 温度补尝，  4℃  4*1.8=7.2    (7) ℉ */
#define   TEMP_CONTROL_NEGATIVE     0.5 /* 负数 恢复   1℃  1*1.8=1.8    (2) ℉ */
#define   TEMP_CONTROL_POSITIVE     0.5 /* 正数 保护 0.5℃  0.5*1.8=0.9  (1) ℉ */
/************************************************************
* 以下为抽风等待常数
*                    			   以下都要以分钟为单位
***********************************************************/
