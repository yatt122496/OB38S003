...
*
*  作者:
*  功能说明：79F081a 类EEPROM的擦写寿命有10W次，若每次只需要保存8个字节，整个512空间划分为64个block，
*             每个block 8个字节，当写满64个block即整个512空间才对全部共2个扇区进行擦除，这样理论上寿
*			  命可以达到10W*(2048/8) = 2560万次，大大提高可靠性能
*
...
************************************************************/
#ifdef   REG79F1622_H
  #define  FLASH_SIZE            2048	//EEPROM大小   SH79F083只有512字节EEPROM
  #define  SECTION_SIZE          0x07
#endif
//
#ifdef   REG79F081A_H
  #define  FLASH_SIZE            2048	//EEPROM大小   SH79F083只有512字节EEPROM
...
//
#ifdef   REG79F083A_H
  #define  FLASH_SIZE            1024//512	//EEPROM大小   SH79F083只有512字节EEPROM
  #define  SECTION_SIZE          0x01
#endif
//
#ifdef   REGSH79F083_H
...
#endif
//
#define  FAN_SECTION_SIZE	   512//256	//EEPROM一个扇区大小
...
* 		SH79F083 控制命令
************************************************************/
#define	 FLASH_CON_CODE        0XFE	//选择代码
...
* 功能说明:
************************************************************/
void WriteEepromLike(unsigned char *ReadWriteData,unsigned char *ReadDatBuf)
{
   bit VoidFull;
   ...
   //-------
   ReadEepromMsg(SaveMsgAddr,ReadDatBuf); //校验
   //-------
}
/************************************************************
* 函数名:
