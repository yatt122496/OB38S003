...
* 机型选择：
************************************************************/
#define  FA23V60_EN     1   //EFBEH
#define  CUN14_EN       0   //EEC2H   F7FAH  RV23V80S
#define  M3022LC_EN     0   //EE60H
#define  RV26D08L_EN    0   //F5F7H
#define  FA26V60_EN     0   //0C61H
//--------------------------------------------
#define  KEY_BG_EN      0   //
#define  TOCH_ANKEY     1   //0 触摸   1：轻触
//0：直接按按键有效   1：背景等亮起，按按键才有效
//--------------------------------------------
#define  SYS_ERROT   (FA23V60_EN + FA26V60_EN + CUN14_EN + M3022LC_EN + RV26D08L_EN)
...
#if ((FA23V60_EN==1) || (RV26D08L_EN==1) || (FA26V60_EN==1))
...
************************************************************/
#if (FA23V60_EN==1)
	#define  DWL1	  P23//P4_0
	#define  DWL2	  P21//P1_5
	//--------------------
	#define  FOT	  P17//P1_7
	#define  DOT	  P03//P3_7
	//--------------------
...
#define  AD_KEY	   0x83	//an1 p11		an9 p11
