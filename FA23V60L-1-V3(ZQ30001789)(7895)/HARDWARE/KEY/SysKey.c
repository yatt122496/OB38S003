...
unsigned char code ShortPressList  [8] ={ 0 , 0 , 0 , 1 , 1 , 0 , 1 };
unsigned char code LongPressList   [8] ={KNC,100,100,KNC,KNC,100,KNC};
...
void KeyCall(unsigned char KeyData)
{
  switch(KeyData)
  {
	...
	case 0x05:HeatKey(1)       ;break;
    case 0x06:TempSetKey()     ;break;
    case   21:TempSw()         ;break;
	case   22:FlaLockKey()     ;break;
	case   25:HeatSetAndLook() ;break;
	default  :                  break;
  }
  Hidden            = 1;
  HiddenTimer       = 0;
