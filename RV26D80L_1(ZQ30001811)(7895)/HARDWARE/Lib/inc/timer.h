...
/***************************************************************************
 ** \brief	TMR2_GET_CC0_CAPTURE
 **			获取捕获通道0的捕获值
 ** \param [in] container ：值存放的容器
 ** \return  none
 ** \note
*****************************************************************************/
#define		TMR2_GET_CC0_CAPTURE(container)		(container = (RLDH<<8) | RLDH))

/***************************************************************************
 ** \brief	TMR2_GET_CC1_CAPTURE
 **			获取捕获通道1的捕获值
 ** \param [in] container ：值存放的容器
 ** \return  none
 ** \note
*****************************************************************************/
#define		TMR2_GET_CC1_CAPTURE(container)		(container = (CCH1<8) | CCL1))
/***************************************************************************
 ** \brief	TMR2_GET_CC2_CAPTURE
 **			获取捕获通道2的捕获值
 ** \param [in] container ：值存放的容器
 ** \return  none
 ** \note
*****************************************************************************/
#define		TMR2_GET_CC2_CAPTURE(container)		(container = (CCH2<<8) | CCL2))
/***************************************************************************
 ** \brief	TMR2_GET_CC3_CAPTURE
 **			获取捕获通道3的捕获值
 ** \param [in] container ：值存放的容器
 ** \return  none
 ** \note
*****************************************************************************/
#define		TMR2_GET_CC3_CAPTURE(container)		(container = (CCH3<<8) | CCL3))
