...
#define  ADC_CH_63_ACMP_VREF	(0x1)				/* AN63接ACMP负端参考电压*/
#define  ADC_CH_63_TS			(0x4)				/* AN63接温度传感器*/
 ...
 **ADC 比较输出
/*---------------------------------------------------------------------------*/
#define  ADC_ADRES_LESS_THAN_ADCMP		(0x01<< ADC_ADCMPC_ADCMPPS_Pos)		/*ADRES < ADCMP ; ADCMPO输出1 */
#define  ADC_ADRES_MORE_THAN_ADCMP		(0x00<< ADC_ADCMPC_ADCMPPS_Pos)		/*ADRES >= ADCMP; ADCMPO输出1*/
 ...
 **			 配置ADC比较输出极性
 ** \param [in]  ADCCMPOut: (1)ADC_ADRES_LESS_THAN_ADCMP 	: ADRES < ADCMP ; ADCMPO输出1
 **						    (2)ADC_ADRES_MORE_THAN_ADCMP 	: ADRES >= ADCMP; ADCMPO输出1
 ** \return  none
 ** \note 
*****************************************************************************/
