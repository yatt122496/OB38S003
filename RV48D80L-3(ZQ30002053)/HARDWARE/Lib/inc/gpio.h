...
/*--比较器输出通道-----------------------------------------------------*/
#define  GPIO_P10_MUX_C0O	(0x05)			/*比较器0输出*/

#define  GPIO_P02_MUX_C1O	(0x05)		   /*比较器1输出*/
...
#define  GPIO_P00_MUX_CAP0	(0x00)		/*PS_CAP0寄存器*/
#define  GPIO_P01_MUX_CAP1	(0x01)		/*PS_CAP1寄存器*/
#define  GPIO_P15_MUX_CAP2	(0x15)		/*PS_CAP2寄存器*/
#define  GPIO_P14_MUX_CAP3	(0x14)		/*PS_CAP3寄存器*/
...
#define  GPIO_MUX_LCD		(0x01)			/*LCD功能*/
/*----ADC输入通道-----------------------------------------------------------*/
 ...
 **			 使能GPIO为三态输入模式
 ** \param [in] PortRIS ：方向寄存器 P0TRIS 、P1TRIS 、P2TRIS  、P3TRIS 
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 **			 GPIO开漏功能开启
 ** \param [in] PortOD  :开漏功能寄存器：P0OD、P1OD、P2OD、P3OD
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 **			 GPIO上拉功能开启
 ** \param [in] PortUP  :上拉功能寄存器：P0UP、P1UP、P2UP、P3UP
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 **			 GPIO下拉功能开启
 ** \param [in] PortRD  :下拉功能寄存器：P0RD、P1RD、P2RD、P3RD
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 **			 GPIO慢斜率功能开启
 ** \param [in] PortSR  :斜率控制功能寄存器：P0SR、P1SR、P2SR、P3SR
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 ** \brief	 GPIO_SET_PXDS
 **			 设置GPIO_PxDS寄存器
 ** \param [in] PorrDS  :数据输入功能寄存器：P0SR、P1SR、P2SR、P3SR
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 ** \brief	 GPIO_CLR_PXDS
			清零GPIO_PxDS寄存器
 ** \param [in] PorrDS  :数据输入控制功能寄存器：P0SR、P1SR、P2SR、P3SR
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
